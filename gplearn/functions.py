...
arcsinh1 = make_function(function=np.arcsinh, name='arcsinh', arity=1)
arccosh1 = make_function(function=_protected_arccosh, name='arccosh', arity=1)
arcsin1 = make_function(function=np.arcsin, name='arcsin', arity=1)
arccos1 = make_function(function=np.arccos, name='arccos', arity=1)
